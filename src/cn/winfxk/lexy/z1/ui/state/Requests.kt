 ...
 * 请求数
 */
class Requests : Selement(), MouseListener {
    private val hint = JLabel("请求状态");
    private val hintTitle = JLabel("当前请求数/最大请求数");
    ...
    init {
        ...
        Deploy.scope.launch {
            while (cn.winfxk.lexy.z1.isRunning) {
                context.text = "${MyBusinessHandler.requestCount}/${MyBusinessHandler.maxRequestCount}"
                delay(5000);
            }
        }
